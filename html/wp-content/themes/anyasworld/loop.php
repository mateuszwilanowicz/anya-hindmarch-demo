...
<?php /* How to display posts in the Gallery category. */ ?>
	...
	<?php if ( in_category( _x('gallery', 'gallery category slug', 'bare') ) ) : ?>
...
<?php else : ?>			
				...
				?>
						...
						<p><em><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 'bare' ),
								'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'bare' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
								$total_images
							); ?></em></p>
				<?php endif; ?>
						<?php the_excerpt(); ?>
<?php endif; ?>
			...
			<div class="entry-utility">
				<a href="<?php echo get_term_link( _x('gallery', 'gallery category slug', 'bare'), 'category' ); ?>" title="<?php esc_attr_e( 'View posts in the Gallery category', 'bare' ); ?>"><?php _e( 'More Galleries', 'bare' ); ?></a>
				<span class="meta-sep">|</span>
				<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'bare' ), __( '1 Comment', 'bare' ), __( '% Comments', 'bare' ) ); ?></span>
				<?php edit_post_link( __( 'Edit', 'bare' ), '<span class="meta-sep">|</span> <span class="edit-link">', '</span>' ); ?>
			</div><!-- .entry-utility -->
		</div><!-- #post-## -->

<?php /* How to display posts in the asides category */ ?>

	<?php elseif ( in_category( _x('asides', 'asides category slug', 'bare') ) ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="entry-utility">
				<?php if ( count( get_the_category() ) ) : ?>
					<span class="cat-links">
						<?php printf( __( '<span class="%1$s">Posted in</span> %2$s', 'bare' ), 'entry-utility-prep entry-utility-prep-cat-links', get_the_category_list( ', ' ) ); ?>
					</span>
					<span class="meta-sep">|</span>
				<?php endif; ?>
				<?php
				...
				?>
					<span class="tag-links">
						<?php printf( __( '<span class="%1$s">Tagged</span> %2$s', 'bare' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?>
					</span>
					<span class="meta-sep">|</span>
				<?php endif; ?>
				<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'bare' ), __( '1 Comment', 'bare' ), __( '% Comments', 'bare' ) ); ?></span>
