...
function register_mysettings(){
	...
	register_setting( 'wordpress-facebook-grabber', 'photo_offset' ); 
	...
	register_setting( 'wordpress-facebook-grabber', 'album_id' );  
}
...
<form method="post" action="options.php">
    ...
    <table class="form-table">
        ...
        <td><input type="text" name="album_id" value="<?php echo get_option('album_id'); ?>" /></td>
        </tr>
		
		<tr valign="top">
        <th scope="row">Facebook Photo Offset</th>
        <td><input type="text" name="photo_offset" value="<?php echo get_option('photo_offset'); ?>" /></td>
        </tr>
